...
export default async function handler(req, res) {
  ...
  // Contexto do publico (vem CONFIRMADO pelo usuario apos etapa de deteccao)
  const contextoPublico = publico ? `
CONTEXTO DO PUBLICO DESTA PAGINA (ja validado pelo usuario):
...
IMPORTANTE: Esses dados ja foram validados antes da analise. Use como verdade para calibrar sua avaliacao. Por exemplo: se o publico e frio puro, espere que a pagina precise quebrar mais objecoes; se e quente/remarketing, espere que va direto na decisao. Se o nicho e tecnico, espere densidade tecnica nos bullets; se e generalista, espere linguagem mais acessivel.
` : '';
...
ATENCAO CRITICA: Voce DEVE responder APENAS com um objeto JSON valido. Nao escreva texto antes do JSON. Nao escreva texto depois. Nao use markdown. Nao use \`\`\`json. Apenas o objeto JSON puro, comecando com { e terminando com }.
